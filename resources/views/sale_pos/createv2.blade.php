...
<head>
    ...
    <title>{{ __('sale.pos_sale') }} - {{ config('app.name', 'POS') }}</title>
...
<body>
    <div class="no-print">
        ...
        <div class="row">
            <div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-7 @else col-md-10 col-md-offset-1 @endif" style="padding-right: 10px;">
                <div class="modern-card pos-container">
                    ...
                    <div class="pos-header">
                        @include('sale_pos.partials.pos_form_v2_header')
                    </div>

                    <!-- POS Products Table (Scrollable) -->
                    <div class="pos-products scrollable-products">
                        @include('sale_pos.partials.pos_form_v2_table')
                    </div>
