		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row @if(!$is_discount_enabled) hide @endif">
					...
					<div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::select('discount_type_modal__', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], $discount_type , ['class' => 'form-control discount_type_modal_','placeholder' => __('messages.please_select'), 'required']); !!}
				            </div>
				        </div>
				    </div>
				    @php
				    ...
				    <div class="col-md-6">
				        <div class="form-group">
				            {!! Form::label('discount_amount_modal__', __('sale.discount_amount') . ':*' ) !!}
				            <div class="input-group">
				                <span class="input-group-addon">
				                    <i class="fa fa-info"></i>
				                </span>
				                {!! Form::text('discount_amount_modal', @num_format($sales_discount), ['class' => 'form-control input_number discount_amount_modal_', 'data-max-discount' => $max_discount, 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', ['discount' => $max_discount != '' ? @num_format($max_discount) : '']) ]); !!}
				            </div>
				        </div>
				    </div>
				</div>
