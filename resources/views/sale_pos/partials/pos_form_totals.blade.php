	...
	<div class="col-md-12">
		<table class="table table-condensed">
			...
			<tr>
				...
				<td>
					<span>
						<b>@lang('Plastic Bag Fees')(+): @show_tooltip(__('tooltip.plastic_bags'))</b>
						<i class="fas fa-edit cursor-pointer"  title="@lang('Plastic Bag Selection')" aria-hidden="true" data-toggle="modal" data-target="#posPlasticbagModal"></i>
						<span id="plasticbag_charges_amount">0</span>
						<input type="hidden" name="plasticbag_charges" id="plasticbag_charges" value="@if(empty($edit)){{@num_format(0.00)}} @else{{@num_format($transaction->plasticbag_charges ?? 0.00)}} @endif" data-default="0.00">
					</span>
				</td>
