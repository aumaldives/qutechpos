...
<div class="form-group col-md-3">
    {!! Form::label('join_date', __( 'lang_v1.join_date' ) . ':*') !!} @show_tooltip(__('lang_v1.join_date_help'))
    {!! Form::text('join_date', !empty($user->join_date) ? @format_date($user->join_date) : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.join_date'), 'readonly', 'required', 'id' => 'user_join_date' ]); !!}
</div>
@endif
<div class="form-group col-md-3">
