...
<section class="content content-custom no-print">
    ...
    <link rel="stylesheet" href="{{ asset('css/modern-dashboard-cards.css?v=' . time()) }}">
        	...
        	<div class="row">
                <div class="col-md-4 col-xs-12">
                    @if(count($all_locations) > 1)
                        {!! Form::select('dashboard_location', $all_locations, null, ['class' => 'form-control select2', 'placeholder' => 'All Business Locations', 'id' => 'dashboard_location']); !!}
                    @endif
                </div>
                    ...
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('home.total_sell') }}</h3>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('lang_v1.net') }} @show_tooltip(__('lang_v1.net_home_tooltip'))</h3>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('home.invoice_due') }}</h3>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('lang_v1.total_sell_return') }}</h3>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('home.total_purchase') }}</h3>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('home.purchase_due') }}</h3>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('lang_v1.total_purchase_return') }}</h3>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title">{{ __('lang_v1.expense') }}</h3>
...
{!! $sells_chart_2->container() !!}
        ...
        <div class="row">
            @if(auth()->user()->can('so.view_all') || auth()->user()->can('so.view_own'))
                <div class="row2" @if(!auth()->user()->can('dashboard.data'))style="margin-top: 190px !important;"@endif>
                    <div class="col-sm-6">
                        @component('components.widget', ['class' => 'box-warning'])
                            @slot('icon')
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped ajax_view" id="sales_order_table">
                                            <thead>
                                                <tr>
                                                    <th>@lang('messages.action') 123</th>
