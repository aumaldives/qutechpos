...
<section class="content">
    ...
    <div class="row no-print">
        <div class="col-sm-12">
            <button type="button" class="btn btn-primary pull-right" aria-label="Print" onclick="window.print();"><i class="fa fa-print"></i> @lang( 'messages.print' )</button>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active" id="input_tab_holder">
                        <a href="#input_tax_tab" data-toggle="tab" aria-expanded="true" class="input_mira_link_button"><i class="fa fas fa-arrow-circle-down" aria-hidden="true"></i> @lang('report.input_tax')</a>
                    </li>

                    <li id="output_tab_holder">
                        <a href="#output_tax_tab" data-toggle="tab" aria-expanded="true" class="output_mira_link_button"><i class="fa fas fa-arrow-circle-up" aria-hidden="true"></i> @lang('report.output_tax')</a>
                    </li>
