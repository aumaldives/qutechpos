<div class="row">
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      ...
      <tr class="info">
        <th>
          @lang('cash_register.adjustments'):
        </th>
        <td>
          <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_cash_adjustments ?? 0 }}</span>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand + $register_details->total_cash - $register_details->total_cash_refund + ($register_details->total_cash_adjustments ?? 0) }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
