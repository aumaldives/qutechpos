        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::tel('mobile', null, ['class' => 'form-control','placeholder' => __('lang_v1.business_telephone'), 'required', 'pattern' => '[34679][0-9]{6}', 'maxlength' => '7']); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::tel('alternate_number', null, ['class' => 'form-control','placeholder' => __('business.alternate_number'), 'required', 'pattern' => '[34679][0-9]{6}', 'maxlength' => '7']); !!}
                </div>
            </div>
        </div>
...
<!-- tax details -->
@if(empty($is_admin))
<h3 class="section-to-hide d-none">@lang('business.business_settings')</h3>
...
<!-- Owner Information -->
@if(empty($is_admin))
<h3 class="section-to-hide d-none">@lang('business.owner')</h3>
@endif
