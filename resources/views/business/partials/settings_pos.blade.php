    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('enable_exc_tax', 1, $business->enable_exc_tax , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_exc_tax' ) }}
                  </label>
                  @show_tooltip(__('lang_v1.price_exc_tax_help_text'))
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('enable_avl_quantity_pos', 1, $business->enable_avl_quantity_pos , 
                    [ 'class' => 'input-icheck']); !!} {{ 'Show Remaining Stock in POS' }}
                  </label>
                  @show_tooltip(__('Check this to enable available quantity on POS Screen'))
                </div>
            </div>
        </div>
