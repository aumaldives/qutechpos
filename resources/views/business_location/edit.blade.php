    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('activity_number', __( 'lang_v1.activity_number' ) . ':') !!}
                        {!! Form::text('activity_number', $location->activity_number, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.activity_number')]); !!}
                    </div>
                </div>
