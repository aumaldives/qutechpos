    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="imeiModalLabel">@lang('lang_v1.add_imei_numbers')</h4>
                <small id="product_name_display"></small>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <label>@lang('lang_v1.quantity'):</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <button type="button" id="generate_imei_fields" class="btn btn-primary">
                            <i class="fa fa-plus"></i> @lang('lang_v1.generate_imei_fields')
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="save_imei_numbers">@lang('messages.save')</button>
