        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              @endif
              @endif
              <th class="no-print">@lang('lang_v1.imei_numbers')</th>
            ...
            <tr>
              ...
              <td class="no-print">
                @if(!empty($purchase_line_imeis[$purchase_line->id]))
                  @foreach($purchase_line_imeis[$purchase_line->id] as $imei)
                    <span class="label label-info" style="margin: 2px;">{{ $imei }}</span>
                  @endforeach
                @else
