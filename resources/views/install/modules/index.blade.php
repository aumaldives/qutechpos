...
<div class="row">
    ...
    @component('components.widget')
        <table class="table">
            ...
            @php
                try {
                    if (isset($mods) && !empty($mods) && is_string($mods)) {
                        $mods = unserialize($mods);
                        if ($mods === false || !is_array($mods)) {
                            $mods = [];
                        }
                    } else {
                        $mods = [];
