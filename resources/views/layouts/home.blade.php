...
<head>
    ...
    <title>@lang('lang_v1.login') - Qutech POS</title>
    ...
    <div class="absolute top-6 right-6 z-20">
        <select id="change_lang" onchange="changeLanguage(this.value)"
            ...
            @foreach(config('constants.langs') as $key => $val)
                <option value="{{$key}}" class="text-gray-800"
                    ...
                    <form method="POST" action="{{ route('login') }}" id="login-form" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center">
                                ...
                                >
                                <span class="ml-2 block text-sm text-gray-700">@lang('lang_v1.remember_me')</span>
                            </label>

                            <a href="{{ route('password.request') }}" class="text-sm text-gray-600 hover:text-gray-800 transition duration-200">
