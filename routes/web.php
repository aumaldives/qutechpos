...
use App\Http\Controllers\KitchenSettingsController;
...
use App\Http\Controllers\ImeiSalesSearchController;
use App\Http\Controllers\R2FileController;
use App\Http\Controllers\PlasticBagController;
...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('/', function () {
        ...
        /* if($user){
            ...
            if ($user->user_type == 'user_customer') {
                return redirect()->route('contact/contact-dashboard');
            }
    ...
    Route::get('/otp/verify', [BusinessController::class, 'getOtpVerify'])->name('otp.verify');
    Route::post('/otp/verify', [BusinessController::class, 'postOtpVerify'])->name('otp.verify.post');
    Route::post('/otp/resend', [BusinessController::class, 'resendOtp'])->name('otp.resend');
    ...
    Route::get('/quote/{token}', [SellPosController::class, 'showInvoice'])
        ->name('show_quote');
    Route::get('/invoice/{token}/payment', [SellPosController::class, 'showInvoicePayment'])
        ->name('show_invoice_payment');
    Route::post('/invoice/{token}/bank-transfer', [SellPosController::class, 'submitBankTransferPayment'])
        ->name('submit_bank_transfer_payment');
...
Route::get('/public-payment/{token}', [PublicPaymentController::class, 'show'])->name('public-payment.show');
Route::post('/public-payment/{token}', [PublicPaymentController::class, 'submit'])->name('public-payment.submit');
Route::get('/public-payment/{token}/download-invoice/{invoice_id}', [PublicPaymentController::class, 'downloadInvoice'])->name('public-payment.download-invoice');

//Routes for authenticated users only
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    // Public payment management routes
    Route::post('/public-payment/approve/{submission_id}', [PublicPaymentController::class, 'approve'])->name('public-payment.approve');
    ...
    Route::put('api-keys/{api_key}/revoke', [ApiKeyController::class, 'revoke'])->name('api-keys.revoke');
    Route::put('api-keys/{api_key}/activate', [ApiKeyController::class, 'activate'])->name('api-keys.activate');
    ...
    Route::get('/api-docs/interactive', [ApiDocumentationController::class, 'interactive'])->name('api-docs.interactive');
    Route::get('/api-docs/playground', [ApiDocumentationController::class, 'playground'])->name('api-docs.playground');
    Route::get('/api-docs/code-examples', [ApiDocumentationController::class, 'codeExamples'])->name('api-docs.code-examples');
    Route::get('/api-docs/openapi.json', [ApiDocumentationController::class, 'openApiJson'])->name('api-docs.openapi-json');
    ...
    Route::get('/webhook-deliveries/{delivery}/details', [WebhookController::class, 'deliveryDetails'])->name('webhook-deliveries.details');
    ...
    Route::get('/bank-transfer-settings', [BusinessController::class, 'getBankTransferSettings'])->name('bank-transfer-settings.index');
    Route::get('/kitchen-settings', [KitchenSettingsController::class, 'index'])->name('kitchen-settings.index');
    Route::post('/kitchen-settings', [KitchenSettingsController::class, 'update'])->name('kitchen-settings.update');
    Route::get('/kitchen-settings/categories', [KitchenSettingsController::class, 'getCategories'])->name('kitchen-settings.categories');
    ...
    // Multi-invoice payment management routes
    Route::get('/pending-payments/multi/{id}', [PendingPaymentController::class, 'showMultiPayment'])->name('pending-payments.show-multi');
    Route::post('/pending-payments/approve-multi/{id}', [PendingPaymentController::class, 'approveMultiPayment'])->name('pending-payments.approve-multi');
    Route::post('/pending-payments/reject-multi/{id}', [PendingPaymentController::class, 'rejectMultiPayment'])->name('pending-payments.reject-multi');
    ...
    Route::post('/contacts/{id}/generate-payment-token', [ContactController::class, 'generatePaymentToken'])->name('contacts.generate-payment-token');
    Route::get('/contacts/{id}/payment-link', [ContactController::class, 'getPaymentLink'])->name('contacts.payment-link');
    ...
    Route::get('/products/get-sub-unit-prices', [ProductController::class, 'get_sub_unit_prices']);
    ...
    Route::get('/sells/load-more-suspended', [SellController::class, 'loadMoreSuspended']);
    ...
    Route::post('/pos/search-available-imeis', [SellPosController::class, 'searchAvailableImeis'])->name('pos.search-available-imeis');
    ...
    // IMEI Sales Search Routes
    Route::get('/imei-sales-search', [ImeiSalesSearchController::class, 'index'])->name('imei-sales-search.index');
    Route::get('/imei-sales-search/data', [ImeiSalesSearchController::class, 'searchByImei'])->name('imei-sales-search.data');
    Route::get('/imei-sales-search/quick-search', [ImeiSalesSearchController::class, 'quickSearch'])->name('imei-sales-search.quick-search');
    ...
    Route::get('/reports/plastic-bag-report', [ReportController::class, 'getPlasticBagReport']);
    ...
    Route::post('/reports/mira-tax-report', [ReportController::class, 'getMiraTaxReport']);
    Route::post('/reports/mira-input-tax-report', [ReportController::class, 'getMiraInputTaxReport']);
    ...
    Route::get('/cash-register/cash-adjustment', [CashRegisterController::class, 'getCashAdjustment']);
    Route::post('/cash-register/cash-adjustment', [CashRegisterController::class, 'postCashAdjustment']);
    ...
    Route::prefix('modules')->group(function () {
        ...
        Route::post('/refresh-orders-list-waiter', [Restaurant\OrderController::class, 'refreshOrdersList']);
        ...
        Route::get('/print-kot', [Restaurant\KitchenController::class, 'printKot']);
    });
    ...
    // Plastic Bag Management Routes
    Route::prefix('plastic-bag')->group(function () {
        // Types management
        Route::get('/types', [PlasticBagController::class, 'types'])->name('plastic_bag.types.index');
        Route::get('/types/create', [PlasticBagController::class, 'createType'])->name('plastic_bag.types.create');
        Route::post('/types', [PlasticBagController::class, 'storeType'])->name('plastic_bag.types.store');
        Route::get('/types/{id}/edit', [PlasticBagController::class, 'editType'])->name('plastic_bag.types.edit');
        Route::put('/types/{id}', [PlasticBagController::class, 'updateType'])->name('plastic_bag.types.update');
        Route::delete('/types/{id}', [PlasticBagController::class, 'deleteType'])->name('plastic_bag.types.destroy');
        
        // Purchases management
        Route::get('/purchases', [PlasticBagController::class, 'purchases'])->name('plastic_bag.purchases.index');
        Route::get('/purchases/create', [PlasticBagController::class, 'createPurchase'])->name('plastic_bag.purchases.create');
        Route::post('/purchases', [PlasticBagController::class, 'storePurchase'])->name('plastic_bag.purchases.store');
        Route::get('/purchases/{id}', [PlasticBagController::class, 'showPurchase'])->name('plastic_bag.purchases.show');
        Route::get('/purchases/{id}/edit', [PlasticBagController::class, 'editPurchase'])->name('plastic_bag.purchases.edit');
        Route::put('/purchases/{id}', [PlasticBagController::class, 'updatePurchase'])->name('plastic_bag.purchases.update');
        Route::delete('/purchases/{id}', [PlasticBagController::class, 'deletePurchase'])->name('plastic_bag.purchases.destroy');
        
        // Stock adjustments
        Route::get('/stock-adjustments', [PlasticBagController::class, 'stockAdjustments'])->name('plastic_bag.adjustments.index');
        Route::get('/stock-adjustments/create', [PlasticBagController::class, 'createAdjustment'])->name('plastic_bag.adjustments.create');
        Route::post('/stock-adjustments', [PlasticBagController::class, 'storeAdjustment'])->name('plastic_bag.adjustments.store');
        Route::delete('/stock-adjustments/{id}', [PlasticBagController::class, 'deleteAdjustment'])->name('plastic_bag.adjustments.destroy');
        
        // Stock transfers
        Route::get('/stock-transfers', [PlasticBagController::class, 'stockTransfers'])->name('plastic_bag.transfers.index');
        Route::get('/stock-transfers/create', [PlasticBagController::class, 'createTransfer'])->name('plastic_bag.transfers.create');
        Route::post('/stock-transfers', [PlasticBagController::class, 'storeTransfer'])->name('plastic_bag.transfers.store');
        Route::put('/stock-transfers/{id}/receive', [PlasticBagController::class, 'receiveTransfer'])->name('plastic_bag.transfers.receive');
        Route::put('/stock-transfers/{id}/cancel', [PlasticBagController::class, 'cancelTransfer'])->name('plastic_bag.transfers.cancel');
        Route::delete('/stock-transfers/{id}', [PlasticBagController::class, 'deleteTransfer'])->name('plastic_bag.transfers.destroy');
        
        // Price adjustments
        Route::get('/adjust-prices', [PlasticBagController::class, 'adjustPrices'])->name('plastic_bag.adjust_prices');
        Route::post('/update-prices', [PlasticBagController::class, 'updatePrices'])->name('plastic_bag.update_prices');
        Route::get('/price-adjustments', [PlasticBagController::class, 'priceAdjustments'])->name('plastic_bag.price_adjustments.index');
        Route::get('/price-adjustments/create', [PlasticBagController::class, 'createPriceAdjustment'])->name('plastic_bag.price_adjustments.create');
        Route::post('/price-adjustments', [PlasticBagController::class, 'storePriceAdjustment'])->name('plastic_bag.price_adjustments.store');
        
        // POS API endpoints
        Route::get('/get-plastic-bag-types-for-pos', [PlasticBagController::class, 'getPlasticBagTypesForPos'])->name('plastic_bag.pos.get_types');
        Route::get('/get-suppliers', [PlasticBagController::class, 'getSuppliers'])->name('plastic_bag.get_suppliers');
        Route::get('/get-plastic-bag-stock/{id}', [PlasticBagController::class, 'getPlasticBagStock'])->name('plastic_bag.get_stock');
    });

    // Pending Payment routes
    Route::get('/pending-payments', [PendingPaymentController::class, 'index'])->name('pending-payments.index');
    Route::get('/pending-payments/{id}', [PendingPaymentController::class, 'show'])->name('pending-payments.show');
    Route::post('/pending-payments/{id}/approve', [PendingPaymentController::class, 'approve'])->name('pending-payments.approve');
    Route::post('/pending-payments/{id}/reject', [PendingPaymentController::class, 'reject'])->name('pending-payments.reject');

    // Bank Transfers Proxy routes
    Route::get('/bank-transfers/get-transfers', [App\Http\Controllers\BankTransfersProxyController::class, 'getTransfers'])->name('bank-transfers.get-transfers');
    Route::post('/bank-transfers/mark-payment-status', [App\Http\Controllers\BankTransfersProxyController::class, 'markPaymentStatus'])->name('bank-transfers.mark-payment-status');
    Route::post('/bank-transfers/force-check', [App\Http\Controllers\BankTransfersProxyController::class, 'forceCheck'])->name('bank-transfers.force-check');

    // Customer Display Screen
    Route::get('/customer/screen', [App\Http\Controllers\SellPosController::class, 'customerDisplay'])->name('pos.customer-display');
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/purchases/print-imei/{id}', [PurchaseController::class, 'printImeiReport']);
    ...
    Route::get('/business/bank-accounts/{id}', [BusinessController::class, 'getBankAccount']);
    Route::post('/business/bank-accounts', [BusinessController::class, 'storeBankAccount']);
    Route::put('/business/bank-accounts/{id}', [BusinessController::class, 'updateBankAccount']);
    Route::delete('/business/bank-accounts/{id}', [BusinessController::class, 'deleteBankAccount']);
});

Route::get('/uploads/{subFolder}/{fileName}', [R2FileController::class, 'previewFile']);

// Superadmin Routes
Route::prefix('superadmin')->name('superadmin.')->middleware(['auth', 'superadmin'])->group(function () {
    // API Key Management
    Route::prefix('api-keys')->name('api-keys.')->group(function () {
        Route::get('/', [App\Http\Controllers\SuperAdmin\ApiKeyManagementController::class, 'index'])->name('index');
        Route::get('/create', [App\Http\Controllers\SuperAdmin\ApiKeyManagementController::class, 'create'])->name('create');
        Route::post('/', [App\Http\Controllers\SuperAdmin\ApiKeyManagementController::class, 'store'])->name('store');
        Route::post('/{id}/revoke', [App\Http\Controllers\SuperAdmin\ApiKeyManagementController::class, 'revoke'])->name('revoke');
        Route::post('/{id}/activate', [App\Http\Controllers\SuperAdmin\ApiKeyManagementController::class, 'activate'])->name('activate');
        Route::delete('/{id}', [App\Http\Controllers\SuperAdmin\ApiKeyManagementController::class, 'destroy'])->name('destroy');
        Route::get('/stats', [App\Http\Controllers\SuperAdmin\ApiKeyManagementController::class, 'stats'])->name('stats');
    });
});

// Direct route for the URL browser is calling (workaround for compatibility)
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->get('/get-plastic-bag-types-for-pos', [PlasticBagController::class, 'getPlasticBagTypesForPos']);
