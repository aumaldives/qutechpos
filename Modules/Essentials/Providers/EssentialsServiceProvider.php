...
class EssentialsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view::composer(['essentials::layouts.partials.header_part',
            'essentials::layouts.partials.header_part_light',
            ...
            view::composer(['essentials::layouts.partials.header_part',
            'essentials::layouts.partials.header_part_light'], function ($view) {
                ...
                if ($module_util->isModuleInstalled('Essentials')) {
                    ...
                    //Check if OT session is active.
                    $ot_session = OtSession::getActiveSession(auth()->user()->id, $business_id);
                }
    
                $view->with(compact('is_employee_allowed', 'clock_in', 'ot_session'));
            });
        
            view::composer(['essentials::attendance.clock_in_clock_out_modal',
            'essentials::attendance.ot_in_out_modal',
