...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu')->group(function () {
    ...
    Route::prefix('hrm')->group(function () {
        ...
        Route::post('/check-leave-balance', [Modules\Essentials\Http\Controllers\EssentialsLeaveController::class, 'checkLeaveBalance']);
        ...
        Route::post('/ot-in-out', [Modules\Essentials\Http\Controllers\AttendanceController::class, 'otInOut']);
        ...
        // Overtime routes
        Route::resource('/overtime', 'Modules\Essentials\Http\Controllers\OvertimeController')->only(['index', 'create', 'store', 'show', 'edit', 'update', 'destroy']);
        Route::post('/overtime/{id}/approve', [Modules\Essentials\Http\Controllers\OvertimeController::class, 'approve']);
        Route::post('/overtime/{id}/reject', [Modules\Essentials\Http\Controllers\OvertimeController::class, 'reject']);
        Route::post('/overtime/run-detection', [Modules\Essentials\Http\Controllers\OvertimeController::class, 'runDetection']);
    });
});
