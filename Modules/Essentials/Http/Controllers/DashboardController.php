...
class DashboardController extends Controller
{
    ...
    public function hrmDashboard()
    {
        ...
        if (!$has_hr_permissions) {
            abort(403, 'Unauthorized action. You do not have permission to access HR dashboard.');
        }
        ...
        return view('essentials::dashboard.hrm_dashboard')
            ->with(compact('users', 'departments', 'users_by_dept', 'todays_holidays', 'todays_leaves', 'upcoming_leaves', 'is_admin', 'users_leaves', 'upcoming_holidays', 'todays_attendances', 'sales_targets', 'target_achieved_this_month', 'target_achieved_last_month', 'up_comming_births', 'today_births', 'user_leave_balances'));
    }
