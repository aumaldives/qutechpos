	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      	...
	      	<div class="form-group">
	        	<div class="checkbox">
	          		<label>
	            		{!! Form::checkbox('is_paid', 1, true, ['class' => 'input-icheck']); !!} @lang('essentials::lang.leave_type_paid') @show_tooltip(__('essentials::lang.leave_type_paid_help'))
	          		</label>
	        	</div>
	      	</div>
	      	...
	      	<div class="form-group">
	      		...
	      		<label class="radio-inline">
	      			{!! Form::radio('leave_count_interval', 'join_date_anniversary', false); !!} @lang('essentials::lang.join_date_anniversary')
	      		</label>
	      		<label class="radio-inline">
