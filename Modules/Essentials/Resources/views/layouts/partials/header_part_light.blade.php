@if($__is_essentials_enabled && $is_employee_allowed)
	...
	<button 
	    ...
	    style="background: rgba(241, 245, 249, 0.7); color: #374151; border-radius: 6px; transition: all 0.3s ease; backdrop-filter: blur(10px); border: 1px solid rgba(0, 0, 0, 0.06);"
	    >
	    <i class="fa fa-sign-in" style="color: #3b82f6; font-size: 16px;"></i>
	</button>

	<!-- Light Theme Clock Out Button -->
	<button 
		type="button" 
