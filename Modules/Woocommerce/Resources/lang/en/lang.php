...
return [
    ...
    'location_woocommerce_settings' => 'Location WooCommerce Settings',
    'location_woocommerce_configuration' => 'Location WooCommerce Configuration',
    'add_location_configuration' => 'Add Location Configuration',
    'edit_location_configuration' => 'Edit Location Configuration',
    'enable_location_sync' => 'Enable Location Sync',
    'api_configuration' => 'API Configuration',
    'sync_settings' => 'Sync Settings',
    'webhook_configuration' => 'Webhook Configuration',
    'sync_interval_minutes' => 'Sync Interval (Minutes)',
    'webhook_url' => 'Webhook URL',
    'webhook_url_help' => 'Copy this URL and add it to your WooCommerce webhooks settings',
    'copy_webhook_url' => 'Copy Webhook URL',
    'webhook_url_copied' => 'Webhook URL copied to clipboard',
    'test_connection' => 'Test Connection',
    'connection_successful' => 'Connection successful',
    'connection_failed' => 'Connection failed',
    'unexpected_response' => 'Unexpected response from WooCommerce API',
    'location_already_configured' => 'This location already has WooCommerce configuration',
    'location_config_created_successfully' => 'Location configuration created successfully',
    'location_config_updated_successfully' => 'Location configuration updated successfully',
    'location_config_deleted_successfully' => 'Location configuration deleted successfully',
    'location_config_delete_confirm' => 'Are you sure you want to delete this location configuration? All sync data will be lost.',
    'sync_status' => 'Sync Status',
    'last_sync' => 'Last Sync',
    'sync_stats' => 'Sync Statistics',
    'sync_now' => 'Sync Now',
    'sync_started_successfully' => 'Sync started successfully',
    'location_sync_disabled' => 'Sync is disabled for this location',
    'view_sync_logs' => 'View Sync Logs',
    'sync_inventory' => 'Sync Inventory',
    'sync_customers' => 'Sync Customers',
    'sync_orders' => 'Sync Orders',
    'enable_auto_sync' => 'Enable Auto Sync',
    'location_config_not_found' => 'Location configuration not found',
