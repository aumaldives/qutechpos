...
class WoocommerceController extends Controller
{
    ...
    public function apiSettings()
    {
        ...
        $current_location_id = null; // No location selected by default for multi-location interface
        return view('woocommerce::woocommerce.api_settings')
                ->with(compact('default_settings', 'locations', 'current_location_id', 'price_groups', 'module_version', 'cron_job_command', 'business', 'shipping_statuses'));
    }
