...
class MiraReportExport implements WithMultipleSheets
{
    protected $request;
    ...
    public function sheets(): array
    {
        ...
        $settings = System::getProperties([
            ...
            'superadmin_tax_activity_number', 
            'superadmin_gst_percentage'
        ], true);

        return [
            new TaxInvoicesSheet($dateRange, $settings),
            new OtherTransactionsSheet($dateRange, $settings)
        ];
    }
