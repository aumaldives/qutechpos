<div class="pos-tab-content active">
    <div class="row">
        ...
        <!-- MIRA Tax Settings Section -->
        <div class="col-xs-12">
            <h4 class="text-primary">
                <i class="fas fa-file-invoice-dollar"></i> MIRA Tax Settings
            </h4>
            <hr>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('superadmin_business_tin', 'Business TIN:') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-id-card"></i>
                    </span>
                    {!! Form::text('superadmin_business_tin', $settings["superadmin_business_tin"] ?? '', ['class' => 'form-control','placeholder' => 'Business TIN Number']); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('superadmin_tax_activity_number', 'Tax Activity Number:') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-certificate"></i>
                    </span>
                    {!! Form::text('superadmin_tax_activity_number', $settings["superadmin_tax_activity_number"] ?? '', ['class' => 'form-control','placeholder' => 'Tax Activity Number']); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('superadmin_gst_percentage', 'GST Percentage (%):') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-percent"></i>
                    </span>
                    {!! Form::number('superadmin_gst_percentage', $settings["superadmin_gst_percentage"] ?? '8', ['class' => 'form-control','placeholder' => 'GST Percentage', 'step' => '0.01', 'min' => '0']); !!}
                </div>
                <p class="help-block text-muted">Default: 8% (Used for reverse calculation of tax-inclusive amounts)</p>
            </div>
        </div>
        ...
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('usd_to_mvr_exchange_rate', 'USD to MVR Exchange Rate:') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-exchange-alt"></i>
                    </span>
                    {!! Form::number('usd_to_mvr_exchange_rate', $settings['usd_to_mvr_exchange_rate'] ?? '', ['class' => 'form-control', 'step' => '0.0001', 'min' => '0', 'placeholder' => 'e.g., 15.42']) !!}
                </div>
                <p class="help-block text-muted">
                    <i class="fa fa-info-circle"></i> 
                    Set the exchange rate for converting USD subscription amounts to MVR in MIRA reports. 
                    Leave empty to use automatic API rates.
                </p>
            </div>
        </div>
        ...
        <div class="col-xs-6">
            <div class="form-group">
                <label>Current Rate Information:</label>
                <div class="alert alert-info" style="margin-top: 25px;">
                    <small>
                        <strong>Current Rate:</strong> {{ number_format(\Modules\Superadmin\Utils\CurrencyUtil::getUsdToMvrRate(), 4) }} MVR per USD<br>
                        <strong>Source:</strong> {{ !empty($settings['usd_to_mvr_exchange_rate']) ? 'Manual Setting' : 'API/Default' }}
                    </small>
                </div>
            </div>
        </div>
