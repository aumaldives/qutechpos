        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'banks') class="active" @endif><a href="{{action([\Modules\Superadmin\Http\Controllers\BankManagementController::class, 'index'])}}"><i class="fa fa-university"></i> Bank Management</a></li>
