...
return [
    ...
    'restrict_date' => 'Restrict - Signup Before Date',
    'restrict_date_after' => 'Restrict - Signup After Date',
    'is_active' => 'Activate',
    ...
    'stripe_subscription_management' => 'Stripe Subscription Management',
    'current_subscription' => 'Current Subscription',
    'subscription_actions' => 'Subscription Actions',
    'manage_via_stripe' => 'Manage via Stripe Portal',
    'update_payment_method' => 'Update Payment Method',
    'cancel_at_period_end' => 'Cancel at Period End',
    'cancel_immediately' => 'Cancel Immediately',
    'next_billing' => 'Next Billing Date',
    'auto_renewal' => 'Auto Renewal',
    'will_cancel' => 'Will Cancel',
    'enabled' => 'Enabled',
    'update_payment_method_info' => 'Enter your new card details below to update your payment method.',
    'confirm_cancel_at_period_end' => 'Are you sure you want to cancel your subscription at the end of the current billing period?',
    'confirm_cancel_immediately' => 'Are you sure you want to cancel your subscription immediately? This action cannot be undone.',
    'subscription_will_cancel_on' => 'Your subscription will be cancelled on',
    ...
    'subscribe_securely' => 'Subscribe Securely',
    'test_mode' => 'Test Mode',
    'test_card_notice' => 'Use the test card number below for testing payments.',
    'test_card_number' => 'Test Card',
    'payment_authentication' => 'Payment Authentication',
    'secure_authentication_required' => 'Secure Authentication Required',
    'authenticating_payment' => 'Authenticating Your Payment',
    '3ds_authentication_message' => 'Your bank requires additional authentication to complete this payment. Please follow the prompts.',
    'payment_authenticated_successfully' => 'Payment Authenticated Successfully',
    'redirecting_to_subscription' => 'Redirecting you to your subscription...',
    'authentication_failed' => 'Authentication Failed',
    'subscription_details' => 'Subscription Details',
    'subscription_activated_successfully' => 'Subscription activated successfully!',
    'payment_authentication_failed' => 'Payment authentication failed. Please try again.',
    'subscription_confirmation_failed' => 'Subscription confirmation failed. Please contact support.',
    ...
    'all_subscriptions' => 'All Approved Subscriptions',
    ...
    'pay_with_card_description' => 'Pay securely with your credit or debit card',
    'pay_with_bank_description' => 'Pay via direct bank transfer or offline payment',
    'pay_with_paypal_description' => 'Pay securely with your PayPal account',
    'pay_with_razorpay_description' => 'Pay with cards, wallets, and banking options',
    ...
    'auto_renewal_description' => 'Your subscription will automatically renew at the end of each billing period. You can cancel anytime.',
    ...
    'payment_security_notice' => 'Your payment is processed securely using industry-standard encryption.',
    ...
    'location_limit_exceeded' => 'Location Limit Exceeded',
    'action_required' => 'Action Required',
    'package_allows_locations' => 'The :package_name package allows :allowed_locations active locations.',
    'current_active_locations' => 'You currently have :count active locations.',
    'deactivate_locations_required' => 'You need to deactivate :count locations to proceed.',
    'select_locations_to_deactivate' => 'Select locations to deactivate',
    'suggested_locations_to_deactivate' => 'These are the most recently created locations that we suggest deactivating.',
    'choose_from_all_active_locations' => 'Choose which locations to deactivate from all your active locations.',
    'select_locations_to_keep_active' => 'Choose which :limit locations to keep active.',
    'proceed_with_selection' => 'Proceed with Selection',
    
    // Per-location pricing
    'per_location_pricing' => 'Per-Location Pricing',
    'per_location_pricing_help' => 'Enable to charge customers based on the number of locations they want to use',
    'price_per_location' => 'Price Per Location',
    'price_per_location_help' => 'Amount to charge for each location',
    'min_locations' => 'Minimum Locations',
    'min_locations_help' => 'Minimum number of locations customer must purchase',
    'max_locations' => 'Maximum Locations',
    'max_locations_help' => 'Maximum locations allowed (0 = unlimited)',
    'per_location_pricing_note' => 'Customers will choose how many locations they want during checkout and be charged accordingly.',
    'select_location_quantity' => 'Select Number of Locations',
    'choose_locations' => 'Choose Your Locations',
    'per_location_pricing_explanation' => 'Flexible Location-Based Pricing',
    'per_location_package_description' => 'The :package_name package allows you to choose exactly how many locations you need and pay accordingly.',
    'how_many_locations' => 'How many locations do you need?',
    'location_quantity_range' => 'Choose between :min and :max locations',
    'pricing_breakdown' => 'Pricing Breakdown',
    'locations' => 'locations',
    'total_monthly' => 'Total Monthly',
    'location_selection_note' => 'You can add more locations later by upgrading your subscription.',
    'proceed_to_payment' => 'Proceed to Payment',
    'selected' => 'selected',
    'get_started' => 'Get Started',
    'deactivated_locations_note' => 'Note: Deactivated locations can be reactivated later by upgrading your subscription.',
    'upgrade_to_higher_plan' => 'Upgrade to Higher Plan',
    'deactivate_and_proceed' => 'Deactivate Selected & Proceed',
    'select_more_locations' => 'Select :needed more locations',
    'select_required_locations_count' => 'Please select at least :count locations to deactivate',
    'confirm_location_deactivation' => 'Are you sure you want to deactivate the selected locations?',
    'location_limit_exceeded_upgrade_required' => 'Your current :current_package plan allows :current_limit active locations. You have :current_active active locations. Please upgrade your subscription to activate more locations.',
