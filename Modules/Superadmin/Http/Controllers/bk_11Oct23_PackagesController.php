...
class PackagesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['name', 'description', 'location_count', 'user_count', 'product_count', 'invoice_count', 'interval', 'interval_count', 'trial_days', 'price', 'sort_order', 'is_active', 'custom_permissions', 'is_private', 'is_one_time', 'enable_custom_link', 'custom_link',
                'custom_link_text', 'restrict_date', ]);
            ...
            $input['restrict_date'] = empty($input['restrict_date']) ? '' : $input['restrict_date'];
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $packages_details = $request->only(['name', 'id', 'description', 'location_count', 'user_count', 'product_count', 'invoice_count', 'interval', 'interval_count', 'trial_days', 'price', 'sort_order', 'is_active', 'custom_permissions', 'is_private', 'is_one_time', 'enable_custom_link', 'custom_link', 'custom_link_text', 'restrict_date']);
            ...
            $packages_details['custom_link_text'] = empty($packages_details['restrict_date']) ? '' : $packages_details['restrict_date'];
