    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $businesses = Business::leftjoin('subscriptions AS s', function ($join) use ($date_today) {
                $join->on('business.id', '=', 's.business_id')
                            ...
                            ->select(
                                    ...
                                    /* 'u.is_email_verify as is_email_verify', */
                                )->groupBy('business.id');
            ...
            return Datatables::of($query)
                ...
                ->editColumn('is_email_verified', '@if($is_email_verified == 1) <span class="label bg-green">Verified</span> @else <span class="label bg-gray">Pending</span> @endif')
                ...
                ->rawColumns(['action', 'is_active', 'created_at', 'is_email_verified'])
                ->make(true);
        }
