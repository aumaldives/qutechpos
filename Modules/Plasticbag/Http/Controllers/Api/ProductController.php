...
use Modules\Plasticbag\Transformers\CommonResource;
use Modules\Plasticbag\Transformers\ProductResource;
use Modules\Plasticbag\Transformers\VariationResource;
...
class ProductController extends ApiController
{
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/plasticbag/api/product?page=1",
            "last": "http://local.pos.com/plasticbag/api/product?page=32",
            "prev": null,
            "next": "http://local.pos.com/plasticbag/api/product?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/plasticbag/api/product",
            "per_page": 10,
            "to": 10
        }
    }
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/plasticbag/api/variation?page=1",
            "last": null,
            "prev": null,
            "next": "http://local.pos.com/plasticbag/api/variation?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/plasticbag/api/variation",
            "per_page": "2",
            "to": 2
        }
    }
