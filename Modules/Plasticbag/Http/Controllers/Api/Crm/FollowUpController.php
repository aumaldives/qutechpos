...
namespace Modules\Plasticbag\Http\Controllers\Api\Crm;
...
use Modules\Plasticbag\Http\Controllers\Api\ApiController;
...
class FollowUpController extends ApiController
{
     ...
     * @response {
            ...
            "links": {
                "first": "http://local.pos.com/plasticbag/api/crm/follow-ups?page=1",
                "last": "http://local.pos.com/plasticbag/api/crm/follow-ups?page=21",
                "prev": null,
                "next": "http://local.pos.com/plasticbag/api/crm/follow-ups?page=2"
            },
            "meta": {
                "current_page": 1,
                "from": 1,
                "last_page": 21,
                "path": "http://local.pos.com/plasticbag/api/crm/follow-ups",
                "per_page": "2",
                "to": 2,
                "total": 42
            }
     ...
     * @response {
            ...
            "links": {
                "first": "http://local.pos.com/plasticbag/api/crm/leads?page=1",
                "last": "http://local.pos.com/plasticbag/api/crm/leads?page=1",
                "prev": null,
                "next": null
            },
            "meta": {
                ...
                "from": 1,
                "last_page": 1,
                "path": "http://local.pos.com/plasticbag/api/crm/leads",
                "per_page": "10",
                "to": 3,
                "total": 3
            }
