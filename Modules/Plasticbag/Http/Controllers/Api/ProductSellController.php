...
namespace Modules\Plasticbag\Http\Controllers\Api;
...
use Modules\Plasticbag\Transformers\NewContactResource;
use Modules\Plasticbag\Transformers\NewProductResource;
use Modules\Plasticbag\Transformers\NewSellResource;
...
class ProductSellController extends ApiController
{
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/plasticbag/api/new_product?per_page=1&page=1",
            "last": "http://local.pos.com/plasticbag/api/new_product?per_page=1&page=1088",
            "prev": null,
            "next": "http://local.pos.com/plasticbag/api/new_product?per_page=1&page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "last_page": 1088,
            "path": "http://local.pos.com/plasticbag/api/new_product",
            "per_page": "1",
            "to": 1,
            "total": 1088
        }
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/plasticbag/api/new_sell?per_page=1&page=1",
            "last": "http://local.pos.com/plasticbag/api/new_sell?per_page=1&page=213",
            "prev": null,
            "next": "http://local.pos.com/plasticbag/api/new_sell?per_page=1&page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "last_page": 213,
            "path": "http://local.pos.com/plasticbag/api/new_sell",
            "per_page": "1",
            "to": 1,
            "total": 213
        }
     ...
     * @response {
            ...
            "links": {
                "first": "http://local.pos.com/plasticbag/api/new_contactapi?customer_group_id=1&page=1",
                "last": "http://local.pos.com/plasticbag/api/new_contactapi?customer_group_id=1&page=1",
                "prev": null,
                "next": null
            },
            "meta": {
                ...
                "from": 1,
                "last_page": 1,
                "path": "http://local.pos.com/plasticbag/api/new_contactapi",
                "per_page": 10,
                "to": 1,
                "total": 1
            }
