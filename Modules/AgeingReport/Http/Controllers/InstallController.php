...
class InstallController extends Controller
{
    ...
    public function index()
    {
        ...
        $action_url = action('\Modules\AgeingReport\Http\Controllers\InstallController@install');
    ...
    public function install()
    {
        try {
            ...
            $pid = config('ageingreport.pid');
            $response = ageingreport(url('/'), __DIR__, $license_code, $email, $login_username, $type = 1, $pid);
