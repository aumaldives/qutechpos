    ...
    public static function customerNotifications()
    {
        return [
            ...
            'monthly_payment_link' => [
                'name' => __('lang_v1.monthly_payment_link'),
                'extra_tags' => [
                    ['{business_name}', '{business_logo}'],
                    ['{payment_link}', '{total_due_amount}', '{invoice_count}', '{due_date}'],
                    ['{contact_name}', '{contact_custom_field_1}', '{contact_custom_field_2}', '{contact_custom_field_3}', '{contact_custom_field_4}', '{contact_custom_field_5}', '{contact_custom_field_6}', '{contact_custom_field_7}', '{contact_custom_field_8}', '{contact_custom_field_9}', '{contact_custom_field_10}'],
                ],
                'help_text' => 'This SMS will be sent monthly to customers with outstanding invoices. The payment link allows them to pay all due amounts at once.',
            ],
            'payment_approved' => [
                'name' => __('lang_v1.payment_approved'),
                'extra_tags' => [
                    ['{business_name}', '{business_logo}'],
                    ['{payment_amount}', '{payment_method}', '{approval_date}', '{payment_ref_number}'],
                    ['{contact_name}', '{contact_custom_field_1}', '{contact_custom_field_2}', '{contact_custom_field_3}', '{contact_custom_field_4}', '{contact_custom_field_5}', '{contact_custom_field_6}', '{contact_custom_field_7}', '{contact_custom_field_8}', '{contact_custom_field_9}', '{contact_custom_field_10}'],
                ],
                'help_text' => 'This notification is sent when a public payment submission is approved by the admin.',
            ],
        ];
    }
