...
class BusinessLocation extends Model
{
    ...
    /**
     * Relationship with WooCommerce location settings
     */
    public function woocommerceLocationSettings()
    {
        return $this->hasOne(\Modules\Woocommerce\Entities\WoocommerceLocationSetting::class, 'location_id');
    }
}
