...
class CashRegisterUtil extends Util
{
    ...
    /**
     * Get cash adjustment transactions for a register
     *
     * @param int $register_id
     * @return \Illuminate\Database\Eloquent\Collection
     */
    public function getCashAdjustmentTransactions($register_id)
    {
        return CashRegisterTransaction::where('cash_register_id', $register_id)
