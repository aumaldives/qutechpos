...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
	<div class="modal-dialog" role="document">
		...
		<div class="col-md-3">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="pos-save-card"><?php echo app('translator')->get('sale.finalize_payment'); ?></button>
			</div>

		</div>
	</div>
</div><?php /**PATH /var/www/html/resources/views/sale_pos/partials/payment_modal.blade.php ENDPATH**/ ?>