        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('lang_v1.warranty_includes_management_tooltip') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                </div>
            </div>
...
</div><?php /**PATH /var/www/html/resources/views/business/partials/settings_product.blade.php ENDPATH**/ ?>