        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <?php echo Form::tel('mobile', null, ['class' => 'form-control','placeholder' => __('lang_v1.business_telephone'), 'required', 'pattern' => '[34679][0-9]{6}', 'maxlength' => '7']); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <?php echo Form::tel('alternate_number', null, ['class' => 'form-control','placeholder' => __('business.alternate_number'), 'required', 'pattern' => '[34679][0-9]{6}', 'maxlength' => '7']); ?>
...
<!-- tax details -->
<?php if(empty($is_admin)): ?>
<h3 class="section-to-hide d-none"><?php echo app('translator')->get('business.business_settings'); ?></h3>

<fieldset class="section-to-hide d-none">
...
<!-- Owner Information -->
<?php if(empty($is_admin)): ?>
<h3 class="section-to-hide d-none"><?php echo app('translator')->get('business.owner'); ?></h3>
<?php endif; ?>
...
</fieldset><?php /**PATH /var/www/html/resources/views/business/partials/register_form.blade.php ENDPATH**/ ?>