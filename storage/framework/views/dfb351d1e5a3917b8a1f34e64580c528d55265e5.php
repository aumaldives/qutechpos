  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="form-group">
        <?php echo Form::label('barcode', __('product.barcode') . ':*'); ?> <?php
                ...
                ?>
        <?php echo Form::text('barcode', $product->barcode, ['class' => 'form-control',
    ...
    <div class="col-sm-4 <?php if(!session('business.enable_sub_units')): ?> hide <?php endif; ?>">
      <div class="form-group">
        ...
        <select name="sub_unit_ids[]" class="form-control select2" multiple id="sub_unit_ids">
          ...
          <option value="<?php echo e($sub_unit_id, false); ?>" <?php if(is_array($product->sub_unit_ids) &&in_array($sub_unit_id, $product->sub_unit_ids)): ?> selected
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        <small>
          <p class="help-block"><?php echo app('translator')->get('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]); ?>. <?php echo app('translator')->get('lang_v1.aspect_ratio_should_be_1_1'); ?> <?php if(!empty($product->image)): ?> <br> <?php echo app('translator')->get('lang_v1.previous_image_will_be_replaced'); ?> <?php endif; ?></p>
        </small>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      <div class="form-group">
        ...
        <input type="<?php echo e($cf_type, false); ?>" name="<?php echo e($db_field_name, false); ?>" id="<?php echo e($db_field_name, false); ?>" value="<?php echo e($product->$db_field_name, false); ?>" class="form-control" placeholder="<?php echo e($cf, false); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/product/edit.blade.php ENDPATH**/ ?>