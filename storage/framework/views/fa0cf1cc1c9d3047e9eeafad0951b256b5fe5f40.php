            ...
            <div class="col-md-4 business" style="display: none;">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <?php echo Form::text('supplier_business_name', null, ['class' => 'form-control', 'placeholder' => __('business.business_name')]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /var/www/html/resources/views/contact/create.blade.php ENDPATH**/ ?>