		...
		<div class="form-group">
			<div class="input-group">
				...
				<span class="input-group-btn">
					<button type="button" class="btn btn-default bg-white btn-flat add_new_customer" data-name=""  <?php if(!auth()->user()->can('customer.create')): ?> disabled <?php endif; ?>><i class="fas fa-plus-circle fa-lg text-success"></i></button>
				</span>
			</div>
		...
		<div class="form-group">
			<div class="input-group">
				<div class="input-group-btn">
					<button type="button" class="btn btn-default bg-white btn-flat" data-toggle="modal" data-target="#configure_search_modal" title="<?php echo e(__('lang_v1.configure_product_search'), false); ?>"><i class="fas fa-search-plus text-info"></i></button>
				</div>
				...
				<span class="input-group-btn">
					...
					<?php if(isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1): ?>
						...
						title="<?php echo app('translator')->get('lang_v1.weighing_scale'); ?>"><i class="fas fa-balance-scale fa-lg text-warning"></i></button>
					<?php endif; ?>
					

					<button type="button" class="btn btn-default bg-white btn-flat pos_add_quick_product" data-href="<?php echo e(action([\App\Http\Controllers\ProductController::class, 'quickAdd']), false); ?>" data-container=".quick_add_product_modal"><i class="fas fa-plus-circle fa-lg text-success"></i></button>
				</span>
			</div>
		</div>
	</div>
...
<div class="row">
	...
	<?php if(in_array('subscription', $enabled_modules)): ?>
		<div class="col-md-4 col-sm-6">
            ...
            </label><button type="button" data-toggle="modal" data-target="#recurringInvoiceModal" class="btn btn-link"><i class="fad fa-external-link-square text-primary"></i></button><?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
    ...
    <?php echo Form::text('porder_no', !empty($transaction) ? $transaction->porder_no : '', ['class' => 'form-control', 'placeholder' => __('lang_v1.purchase_order_no'), 'id' => 'porder_no']); ?>
...
</div><?php /**PATH /var/www/html/resources/views/sale_pos/partials/pos_form.blade.php ENDPATH**/ ?>