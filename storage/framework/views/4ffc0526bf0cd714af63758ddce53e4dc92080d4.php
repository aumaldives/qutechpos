...
<section class="content-header">
    <h1><?php echo e(__('report.customer'), false); ?> & <?php echo e(__('report.supplier'), false); ?> Balances - Days Outstanding</h1>
    <!-- <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3" id="location_filter_sup">
                <div class="form-group">
                    <?php echo Form::label('location_id_sup', __('purchase.business_location') . ':'); ?>

                    <?php echo Form::select('location_id_sup', $business_locations, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>

                </div>
            </div>
            <div class="col-md-3" id="location_filter_cus" style="display: none;">
                <div class="form-group">
                    <?php echo Form::label('location_id_cus', __('purchase.business_location') . ':'); ?>

                    <?php echo Form::select('location_id_cus', $business_locations, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>
            ...
            <div class="col-md-3" id="customer_filter" style="display: none;">
                <div class="form-group">
                    ...
                    <?php echo Form::select('customer_id', $customers, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); ?>
...
<script>
    ...
    function getCustomerAgeing() {
        ...
        $.ajax({
            method: 'GET',
            url: "<?php echo e(route('supplier-ageing'), false); ?>",
            dataType: 'html',
            data: data,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/AgeingReport/Providers/../Resources/views/index.blade.php ENDPATH**/ ?>