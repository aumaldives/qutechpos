...
<?php if(auth()->user()->can('superadmin') || auth()->user()->hasRole('Admin')): ?>
<div class="form-group col-md-3">
    <?php echo Form::label('join_date', __( 'lang_v1.join_date' ) . ':*'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('lang_v1.join_date_help') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
    <?php echo Form::text('join_date', !empty($user->join_date) ? \Carbon::createFromTimestamp(strtotime($user->join_date))->format(session('business.date_format')) : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.join_date'), 'readonly', 'required', 'id' => 'user_join_date' ]); ?>
...
</div><?php /**PATH /var/www/html/resources/views/user/form.blade.php ENDPATH**/ ?>