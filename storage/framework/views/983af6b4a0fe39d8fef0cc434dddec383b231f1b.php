		...
		<div class="row">
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-aqua">
	            ...
	            <a href="<?php echo e(action([\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController::class, 'index']), false); ?>" class="small-box-footer"><?php echo app('translator')->get('superadmin::lang.more_info'); ?> <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        ...
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-yellow">
	            ...
	            <a href="<?php echo e(action([\Modules\Superadmin\Http\Controllers\BusinessController::class, 'index']), false); ?>" class="small-box-footer"><?php echo app('translator')->get('superadmin::lang.more_info'); ?> <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Modules/Superadmin/Providers/../Resources/views/superadmin/index.blade.php ENDPATH**/ ?>