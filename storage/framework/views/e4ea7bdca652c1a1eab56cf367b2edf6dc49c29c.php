...
<!-- Custom styled help text with documentation link -->
<div class="row">
    <div class="col-xs-12">
        <div class="form-group custom-help-block">
            <div class="col-sm-offset-3 col-sm-9">
                <p class="help-block">
                    <strong>You can find the documentation to setup email SMTP using this <a href="https://support.islebooks.mv/en/articles/8253522-enabling-auto-sending-of-sms-email-to-customer-on-new-sales#h_adcf39b278" target="_blank">Link</a></strong>
                </p>
            </div>
        </div>
    </div>
...
</div><?php /**PATH /var/www/html/resources/views/business/partials/settings_email.blade.php ENDPATH**/ ?>