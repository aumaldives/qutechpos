...
<div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"><?php echo app('translator')->get('lang_v1.suspended_sales'); ?> <small class="text-muted">(Showing latest <?php echo e(count($sales), false); ?> records)</small></h4>
		</div>
		<div class="modal-body">
			<div class="row" style="margin-bottom: 15px;">
				...
				<div class="col-md-6 text-right">
					<small class="text-info" id="records_info">
						...
						Loaded <?php echo e(count($sales), false); ?> records. Scroll down for more.
					</small>
				</div>
			</div>
			<div class="modal-body-scroll" style="max-height: 60vh; overflow-y: auto;" id="suspended_sales_scroll_container">
				<div class="row" id="suspended_sales_container">
					<?php echo $__env->make('sale_pos.partials.suspended_sales_items', ['sales' => $sales, 'is_tables_enabled' => $is_tables_enabled, 'is_service_staff_enabled' => $is_service_staff_enabled, 'transaction_sub_type' => $transaction_sub_type], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(function() {
    var loadedRecords = <?php echo e(count($sales), false); ?>;
    var offset = <?php echo e(count($sales), false); ?>;
    var isLoading = false;
    var hasMoreRecords = <?php echo e(count($sales) >= 50 ? 'true' : 'false', false); ?>;
    var searchTerm = '';
    ...
    function loadMoreSuspendedSales() {
        ...
        $.ajax({
            ...
            data: {
                offset: offset,
                limit: 20,
                transaction_sub_type: '<?php echo e($transaction_sub_type ?? "", false); ?>'
            },
...
</script><?php /**PATH /var/www/html/resources/views/sale_pos/partials/suspended_sales_modal.blade.php ENDPATH**/ ?>