			...
			<div class="modal-body">
					...
					<div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                <?php echo Form::select('discount_type_modal__', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], $discount_type , ['class' => 'form-control discount_type_modal_','placeholder' => __('messages.please_select'), 'required']); ?>
				...
				<div class="row <?php if(!$is_rp_enabled): ?> hide <?php endif; ?>">
				    ...
				    <div class="col-md-6">
				    	...
				    	<h5><strong><?php echo app('translator')->get('lang_v1.redeemed_amount'); ?>:</strong> <span id="rp_redeemed_amount_text"><?php echo e(number_format($rp_redeemed_amount, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span></h5>
				    </div>
				    </div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="updateDiscountButton">Update</button>
...
</div><!-- /.modal --><?php /**PATH /var/www/html/resources/views/sale_pos/partials/edit_discount_modal.blade.php ENDPATH**/ ?>