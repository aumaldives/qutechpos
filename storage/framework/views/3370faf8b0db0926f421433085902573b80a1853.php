...
(function() {
    ...
    var bankTransfersApiUrl = '<?php echo e(route("bank-transfers.get-transfers"), false); ?>';
    var bankTransfersMarkPaymentUrl = '<?php echo e(route("bank-transfers.mark-payment-status"), false); ?>';
    var bankTransfersForceCheckUrl = '<?php echo e(route("bank-transfers.force-check"), false); ?>';
...
<?php /**PATH /var/www/html/resources/views/sale_pos/partials/bank_transfers_modal.blade.php ENDPATH**/ ?>