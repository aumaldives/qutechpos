<?php $__env->startSection('title', __('lang_v1.bank_transfer_settings')); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><?php echo app('translator')->get('lang_v1.bank_transfer_settings'); ?>
        <small><?php echo app('translator')->get('lang_v1.manage_bank_transfer_payment_settings'); ?></small>
    </h1>
</section>
...
<section class="content">
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        <div class="row">
            <div class="col-sm-12">
                <?php echo $__env->make('business.partials.settings_bank_transfer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#add_bank_account').click(function(){
            ...
            $('#account_id').val('');
            $('#modal_title').text('<?php echo app('translator')->get("lang_v1.add_bank_account"); ?>');
        ...
        $(document).on('click', '.edit-bank-account', function(){
            ...
            $.ajax({
                method: 'GET',
                url: '<?php echo e(url("/business/bank-accounts"), false); ?>/' + account_id,
                success: function(data){
                    if(data.success){
                        ...
                        $('#modal_title').text('<?php echo app('translator')->get("lang_v1.edit_bank_account"); ?>');
                        $('#bank_account_modal').modal('show');
                    }
                }
            });
        ...
        $(document).on('click', '#save_bank_account', function(){
            ...
            var url = account_id ? '<?php echo e(url("/business/bank-accounts"), false); ?>/' + account_id : '<?php echo e(url("/business/bank-accounts"), false); ?>';
        ...
        $(document).on('click', '.delete-bank-account', function(){
            ...
            swal({
                title: '<?php echo app('translator')->get("messages.sure"); ?>',
                text: '<?php echo app('translator')->get("lang_v1.delete_bank_account_confirm"); ?>',
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((willDelete) => {
        ...
        $('button[type="submit"]').off('click').on('click', function(e){
            ...
            $.ajax({
                method: 'POST',
                url: '<?php echo e(action([\App\Http\Controllers\BusinessController::class, 'postBusinessSettings']), false); ?>',
                dataType: 'json',
                data: form_data,
                beforeSend: function(xhr) {
                    console.log('AJAX beforeSend triggered');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/business/bank_transfer_settings.blade.php ENDPATH**/ ?>