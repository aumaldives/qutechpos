    ...
    id="purchase_entry_table">
        <thead>
              <tr>
                ...
                <th><?php if(empty($is_purchase_order)): ?> <?php echo app('translator')->get( 'purchase.purchase_quantity' ); ?> <?php else: ?> <?php echo app('translator')->get( 'lang_v1.order_quantity' ); ?> <?php endif; ?></th>
                ...
                <th class="<?php if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)): ?> hide <?php endif; ?>">
...
<input type="hidden" id="row_count" value="<?php echo e($row_count, false); ?>"><?php /**PATH /var/www/html/resources/views/purchase/partials/edit_purchase_entry_row.blade.php ENDPATH**/ ?>