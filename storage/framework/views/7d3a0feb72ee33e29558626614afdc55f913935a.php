    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-white mb-2">
                <i class="fa-solid fa-cart-shopping mr-3"></i><?php echo app('translator')->get('sale.sells'); ?>
            </h1>
        ...
        <div class="border-b border-gray-200 px-6 py-4">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-gray-800 flex items-center">
                    ...
                    <?php echo app('translator')->get('report.filters'); ?>
                </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">
                        ...
                        <?php echo app('translator')->get('purchase.business_location'); ?>
                    </label>
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">
                        ...
                        <?php echo app('translator')->get('purchase.payment_status'); ?>
                    </label>
                    <?php echo Form::select('sell_list_filter_payment_status', [
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">
                        ...
                        <?php echo app('translator')->get('report.date_range'); ?>
                    </label>
                    <input type="text"
                           id="sell_list_filter_date_range"
                           placeholder="<?php echo app('translator')->get('lang_v1.select_a_date_range'); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                           readonly>
                </div>

                <?php if(!empty($sales_representative)): ?>
                <!-- Sales Representative Filter -->
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">
                        <i class="fa-solid fa-user-tie mr-2 text-gray-400"></i>
                        <?php echo app('translator')->get('report.user'); ?>
                    </label>
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">
                        ...
                        <?php echo app('translator')->get('lang_v1.sales_commission_agent'); ?>
                    </label>
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">
                        ...
                        <?php echo app('translator')->get('lang_v1.shipping_status'); ?>
                    </label>
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">
                        ...
                        <?php echo app('translator')->get('lang_v1.sources'); ?>
                    </label>
                ...
                <div class="space-y-2 flex items-end">
                    <label class="flex items-center space-x-3 cursor-pointer">
                        ...
                        <span class="text-sm font-semibold text-gray-700">
                            ...
                            <?php echo app('translator')->get('lang_v1.subscriptions'); ?>
                        </span>
                    </label>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden fade-in">
        <div class="border-b border-gray-200 px-6 py-4 bg-gradient-to-r from-gray-50 to-white">
            <h2 class="text-xl font-bold text-gray-800 flex items-center">
                ...
                <?php echo app('translator')->get('lang_v1.all_sales'); ?>
            </h2>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/sell/index.blade.php ENDPATH**/ ?>