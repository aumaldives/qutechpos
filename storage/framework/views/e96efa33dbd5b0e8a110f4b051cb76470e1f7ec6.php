<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    <?php echo Form::open(['url' => action([\App\Http\Controllers\ProductController::class, 'saveQuickProduct']), 'method' => 'post', 'id' => 'quick_add_product_form' ]); ?>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <?php echo Form::label('barcode', __('product.barcode') . ':'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('tooltip.barcode') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
...
<script type="text/javascript">
  $(document).ready(function() {
        ...
        <tr class="${selectedValue}">
            <td>
                ...
                <div class="col-sm-6">
                    ...
                    <input class="form-control input-sm dpp input_number" placeholder="Exc. tax" required="" name="n_single_dpp[]" type="text" value="" id="single_dpp${id_suffix}">
                </div>
                <div class="col-sm-6">
                    <label for="single_dpp_inc_tax">Inc. tax:*</label>
                    <input class="form-control input-sm dpp_inc_tax input_number" placeholder="Inc. tax" required="" name="n_single_dpp_inc_tax[]" type="text" value="" id="single_dpp_inc_tax${id_suffix}">
                </div>
            </td>
            <td>
                <br>
                <input class="form-control input-sm input_number" id="profit_percent${id_suffix}" required="" name="n_profit_percent[]" type="text" value="">
            </td>
            <td>
                <label><span class="dsp_label">Exc. Tax</span></label>
                <input class="form-control input-sm dsp input_number" placeholder="Exc. tax" id="single_dsp${id_suffix}" required="" name="n_single_dsp[]" type="text" value="">
                <input class="form-control input-sm hide input_number" placeholder="Inc. tax" id="single_dsp_inc_tax${id_suffix}" required="" name="n_single_dsp_inc_tax[]" type="text" value="">
            </td>
            <td>
                <div class="form-group">
    ...
    function addEventListeners(selectedValue) {
      ...
      // Event handler for purchase exc. tax change
      ...
      // Event handler for purchase inc. tax change
      ...
      // Event handler for profit percent change
      $(document).on('change', `input#profit_percent${id_suffix}`, function(e) {
        $(`input#single_dpp${id_suffix}`).change();
      });

      // Event handler for selling price change
      ...
      // Event handler for selling price inc. tax change
...
</script><?php /**PATH /var/www/html/resources/views/product/partials/quick_add_product.blade.php ENDPATH**/ ?>