<?php
  // Always show price section regardless of tax settings
  $default = null;
  $class = '';
?>

<div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed <?php echo e($class, false); ?> price_container">
        <tr>
...
</div><?php /**PATH /var/www/html/resources/views/product/partials/single_product_form_part.blade.php ENDPATH**/ ?>