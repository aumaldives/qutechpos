...
<section class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <?php echo Form::select('tax_report_contact_id', $contact_dropdown, null , ['class' => 'form-control select2', 'id' => 'tax_report_contact_id', 'placeholder' => __('lang_v1.all')]); ?>
    ...
    <div class="row no-print">
        <div class="col-sm-12">
            <button type="button" class="btn btn-primary pull-right" aria-label="Print" onclick="window.print();"><i class="fa fa-print"></i> <?php echo app('translator')->get( 'messages.print' ); ?></button>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active" id="input_tab_holder">
                        <a href="#input_tax_tab" data-toggle="tab" aria-expanded="true" class="input_mira_link_button"><i class="fa fas fa-arrow-circle-down" aria-hidden="true"></i> <?php echo app('translator')->get('report.input_tax'); ?></a>
                    </li>

                    <li id="output_tab_holder">
                        <a href="#output_tax_tab" data-toggle="tab" aria-expanded="true" class="output_mira_link_button"><i class="fa fas fa-arrow-circle-up" aria-hidden="true"></i> <?php echo app('translator')->get('report.output_tax'); ?></a>
                    </li>

                    <li id="expense_tab_holder">
    ...
    $(document).ready(function() {
        ...
        input_tax_table = $('#input_tax_table').DataTable({
            ...
            columns: [{
                ...
                <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
                    data: "tax_<?php echo e($tax['id'], false); ?>",
                    searchable: false,
                    orderable: false
                },
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            buttons: [{
                ...
                {
                    text: '<i class="fa fa-file-excel" aria-hidden="true"></i> ' + 'Export Mira Report',
                    className: 'btn-sm custom_input_button',
                    action: function(e, dt, button, config) {
                        $.ajax({
                            url: '/reports/mira-input-tax-report',
                            type: 'POST',
                            data: {
                                "location_id": $('#tax_report_location_id').val(),
                                "contact_id": $('#tax_report_contact_id').val(),
                                "start_date": $('input#tax_report_date_range').data('daterangepicker').startDate.format('YYYY-MM-DD'),
                                "end_date": $('input#tax_report_date_range').data('daterangepicker').endDate.format('YYYY-MM-DD')
                            },
                            success: function(response) {
                                var downloadLink = $('<a>', {
                                    href: response.fileUrl,
                                    download: 'mira-input_tax_statement.xlsx',
                                }).appendTo('body');
                ...
                if (typeof(output_tax_datatable) == 'undefined') {
                    output_tax_datatable = $('#output_tax_table').DataTable({
                        ...
                        buttons: [{
                            ...
                            {
                                text: '<i class="fa fa-file-excel" aria-hidden="true"></i> ' + 'Export Mira Report',
                                className: 'btn-sm custom_output_button',
                                action: function(e, dt, button, config) {
                                    $.ajax({
                                        url: '/reports/mira-tax-report',
                                        type: 'POST',
                                        data: {
                                            "location_id": $('#tax_report_location_id').val(),
                                            "contact_id": $('#tax_report_contact_id').val(),
                                        ...
                                        success: function(response) {
                                            var downloadLink = $('<a>', {
                                                href: response.fileUrl,
                                                download: 'mira_output_tax_statement.xlsx',
                                            }).appendTo('body');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/report/tax_report.blade.php ENDPATH**/ ?>