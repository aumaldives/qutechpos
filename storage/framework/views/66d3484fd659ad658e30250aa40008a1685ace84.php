...
<section class="content content-custom no-print">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/modern-dashboard-cards.css?v=' . time()), false); ?>">
    
    <style>
        .dashboard-cards-5-col {
            display: flex;
            flex-wrap: wrap;
            margin: 0 -10px;
        }
        .dashboard-card-5-col {
            flex: 0 0 20%;
            max-width: 20%;
            padding: 0 10px;
            margin-bottom: 20px;
        ...
        /* Make chart containers full width on tablets */
        @media (max-width: 1024px) {
            .col-sm-6 {
                width: 100% !important;
    ...
    <?php if(auth()->user()->can('dashboard.data')): ?>
        <?php if($is_admin): ?>
        	<div class="row">
                <div class="col-md-4 col-xs-12">
                    <?php if(count($all_locations) > 1): ?>
                        <?php echo Form::select('dashboard_location', $all_locations, null, ['class' => 'form-control select2', 'placeholder' => 'All Business Locations', 'id' => 'dashboard_location']); ?>
    	   ...
    	   <div class="dashboard-cards-5-col">
                <!-- Card 1: Total Sell -->
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            <div class="modern-card-icon icon-sales">
                                <i class="fas fa-shopping-cart"></i>
                            </div>
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('home.total_sell'), false); ?></h3>
                                <p class="modern-card-value total_sell">
                                    <span class="modern-card-loading">
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            <div class="modern-card-icon icon-net">
                                <i class="fas fa-chart-line"></i>
                            </div>
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('lang_v1.net'), false); ?> <?php
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            <div class="modern-card-icon icon-due">
                                <i class="fa-duotone fa-clock-rotate-left" style="--fa-primary-color: inherit; --fa-secondary-color: rgba(255,255,255,0.3);"></i>
                            </div>
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('home.invoice_due'), false); ?></h3>
                                <p class="modern-card-value invoice_due">
                                    <span class="modern-card-loading">
                                        <i class="fas fa-sync fa-spin"></i>
                                    </span>
                                </p>
                ...
                <!-- Card 4: Total Sell Return -->
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            <div class="modern-card-icon icon-return">
                                <i class="fas fa-exchange-alt"></i>
                            </div>
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('lang_v1.total_sell_return'), false); ?></h3>
                                <p class="modern-card-value total_sell_return">
                                    <span class="modern-card-loading">
                                        <i class="fas fa-sync fa-spin"></i>
                                    </span>
                                </p>
                ...
                <!-- Card 5: Total Purchase -->
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            <div class="modern-card-icon icon-purchase">
                                <i class="fas fa-credit-card"></i>
                            </div>
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('home.total_purchase'), false); ?></h3>
                                <p class="modern-card-value total_purchase">
                                    <span class="modern-card-loading">
                                        <i class="fas fa-sync fa-spin"></i>
                                    </span>
                                </p>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            <div class="modern-card-icon icon-due">
                                <i class="fa-duotone fa-hourglass-clock" style="--fa-primary-color: inherit; --fa-secondary-color: rgba(255,255,255,0.3);"></i>
                            </div>
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('home.purchase_due'), false); ?></h3>
                                <p class="modern-card-value purchase_due">
                                    <span class="modern-card-loading">
                                        <i class="fas fa-sync fa-spin"></i>
                                    </span>
                                </p>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            ...
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('lang_v1.total_purchase_return'), false); ?></h3>
                                <p class="modern-card-value total_purchase_return">
                                    <span class="modern-card-loading">
                                        <i class="fas fa-sync fa-spin"></i>
                                    </span>
                                </p>
                ...
                <div class="dashboard-card-5-col">
                    <div class="modern-dashboard-card">
                        <div class="modern-card-header">
                            <div class="modern-card-icon icon-expense">
                                <i class="fas fa-receipt"></i>
                            </div>
                            <div class="modern-card-content">
                                <h3 class="modern-card-title"><?php echo e(__('lang_v1.expense'), false); ?></h3>
                                <p class="modern-card-value total_expense">
                                    <span class="modern-card-loading">
                                        <i class="fas fa-sync fa-spin"></i>
                                    </span>
                                </p>
                ...
                <!-- Dynamic HR Widgets: Leave and OT Cards -->
                    ...
                    <!-- sales chart start -->
                        <div class="col-sm-6">
                            <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __('home.sells_last_30_days')]); ?>
                              <?php $__env->slot('icon'); ?>
                                <i class="fa-duotone fa-chart-line text-primary" style="--fa-primary-color: #007bff; --fa-secondary-color: #b3d7ff; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                              <?php $__env->endSlot(); ?>
                ...
                <?php if(!empty($all_locations)): ?>
                        <div class="col-sm-6">
                            <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __('home.sells_current_fy')]); ?>
                              <?php $__env->slot('icon'); ?>
                                <i class="fa-duotone fa-chart-column text-primary" style="--fa-primary-color: #007bff; --fa-secondary-color: #b3d7ff; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                              <?php $__env->endSlot(); ?>
<?php echo $sells_chart_2->container(); ?>
      	...
      	<div class="row">
            <?php if(auth()->user()->can('sell.view') || auth()->user()->can('direct_sell.view')): ?>
                <div class="col-sm-6">
                    <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                      <?php $__env->slot('icon'); ?>
                        <i class="fa-duotone fa-money-bill-trend-up text-yellow" style="--fa-primary-color: #ffc107; --fa-secondary-color: #fff3cd; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                      <?php $__env->endSlot(); ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase.view')): ?>
                <div class="col-sm-6">
                    <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                    <?php $__env->slot('icon'); ?>
                    <i class="fa-duotone fa-file-invoice-dollar text-yellow" style="--fa-primary-color: #ffc107; --fa-secondary-color: #fff3cd; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('title'); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stock_report.view')): ?>
            <div class="row">
                <div class="<?php if((session('business.enable_product_expiry') != 1) && auth()->user()->can('stock_report.view')): ?> col-sm-12 <?php else: ?> col-sm-6 <?php endif; ?>">
                    <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                      <?php $__env->slot('icon'); ?>
                        <i class="fa-duotone fa-boxes-stacked text-yellow" style="--fa-primary-color: #ffc107; --fa-secondary-color: #fff3cd; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                      <?php $__env->endSlot(); ?>
                      <?php $__env->slot('title'); ?>
                ...
                <?php if(session('business.enable_product_expiry') == 1): ?>
                    <div class="col-sm-6">
                        <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                          <?php $__env->slot('icon'); ?>
                            <i class="fa-duotone fa-calendar-xmark text-yellow" style="--fa-primary-color: #ffc107; --fa-secondary-color: #fff3cd; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                          <?php $__env->endSlot(); ?>
                          <?php $__env->slot('title'); ?>
        ...
        <div class="row">
            <?php if(auth()->user()->can('so.view_all') || auth()->user()->can('so.view_own')): ?>
                <div class="row2" <?php if(!auth()->user()->can('dashboard.data')): ?>style="margin-top: 190px !important;"<?php endif; ?>>
                    <div class="col-sm-6">
                        <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                            <?php $__env->slot('icon'); ?>
                                <i class="fa-duotone fa-clipboard-list text-yellow" style="--fa-primary-color: #ffc107; --fa-secondary-color: #fff3cd; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                            <?php $__env->endSlot(); ?>
                            <?php $__env->slot('title'); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped ajax_view" id="sales_order_table">
                                            <thead>
                                                <tr>
                                                    <th><?php echo app('translator')->get('messages.action'); ?> 123</th>
            ...
            <?php if(auth()->user()->can('access_pending_shipments_only') || auth()->user()->can('access_shipping') || auth()->user()->can('access_own_shipping') ): ?>
                <div class="col-sm-6">
                    <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                    <?php $__env->slot('icon'); ?>
                        <i class="fa-duotone fa-truck-clock text-yellow" style="--fa-primary-color: #ffc107; --fa-secondary-color: #fff3cd; font-size: 18px; margin-right: 8px;" aria-hidden="true"></i>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('title'); ?>
        ...
        <?php if(!empty($common_settings['enable_purchase_requisition']) && (auth()->user()->can('purchase_requisition.view_all') || auth()->user()->can('purchase_requisition.view_own')) ): ?>
                ...
                <div class="col-sm-12">
                    <?php $__env->startComponent('components.widget', ['class' => 'box-warning']); ?>
                      ...
                      <?php $__env->endSlot(); ?>
                        ...
                        <?php if(count($all_locations) > 1): ?>
                            <div class="col-md-4 col-sm-6 col-md-offset-8 mb-10">
                                <?php echo Form::select('pr_location', $all_locations, null, ['class' => 'form-control select2', 'placeholder' => __('lang_v1.select_location'), 'id' => 'pr_location']); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        ...
        // Modern Dashboard Cards - Remove loading spinner when content loads
        function updateModernCard(selector, content) {
            const cardElement = $(selector);
            if (cardElement.length) {
                const loadingSpinner = cardElement.find('.modern-card-loading');
                if (loadingSpinner.length) {
                    loadingSpinner.fadeOut(300, function() {
                        cardElement.html(content);
                        cardElement.fadeIn(300);
                    });
                } else {
                    cardElement.html(content);
                }
        ...
        // Override existing card update functions to use modern cards
        const originalUpdate = window.updateDashboardCards || function() {};
        
        // Enhanced card update observer
        const cardObserver = new MutationObserver(function(mutations) {
            mutations.forEach(function(mutation) {
                if (mutation.target.classList.contains('total_sell') || 
                    mutation.target.classList.contains('net') ||
                    mutation.target.classList.contains('invoice_due') ||
                    mutation.target.classList.contains('total_sell_return') ||
                    mutation.target.classList.contains('total_purchase') ||
                    mutation.target.classList.contains('purchase_due') ||
                    mutation.target.classList.contains('total_purchase_return') ||
                    mutation.target.classList.contains('total_expense')) {
                    
                    // Remove loading spinner when content is updated
                    const loadingSpinner = $(mutation.target).find('.modern-card-loading');
                    if (loadingSpinner.length && mutation.target.textContent.trim() !== '') {
        ...
        // Start observing dashboard cards
        $('.modern-card-value').each(function() {
