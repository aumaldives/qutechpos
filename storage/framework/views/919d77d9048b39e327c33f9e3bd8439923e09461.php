			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="checkbox">
							<label>
				              	<?php echo Form::checkbox('search_fields[]', 'barcode', true, ['class' => 'input-icheck search_fields']); ?> <?php echo app('translator')->get('product.barcode'); ?>
				            </label>
						</div>
					</div>
...
</div><?php /**PATH /var/www/html/resources/views/sale_pos/partials/configure_search_modal.blade.php ENDPATH**/ ?>