    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    <?php echo Form::checkbox('enable_exc_tax', 1, $business->enable_exc_tax , 
                    [ 'class' => 'input-icheck']); ?> <?php echo e(__( 'lang_v1.enable_exc_tax' ), false); ?>
                ...
                if(session('business.enable_tooltip')){
                    ...
                    data-content="' . __('lang_v1.price_exc_tax_help_text') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    <?php echo Form::checkbox('enable_avl_quantity_pos', 1, $business->enable_avl_quantity_pos , 
                    [ 'class' => 'input-icheck']); ?> <?php echo e('Show Remaining Stock in POS', false); ?>
                ...
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('Check this to enable available quantity on POS Screen') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                </div>
            </div>
...
</div><?php /**PATH /var/www/html/resources/views/business/partials/settings_pos.blade.php ENDPATH**/ ?>